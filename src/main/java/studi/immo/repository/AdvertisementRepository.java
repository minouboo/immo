...
public interface AdvertisementRepository extends JpaRepository <Advertisement, Long> {
    ...
    @Query (value = "select * from advertisement ad where ad.accommodation_id= :accommodationid", nativeQuery = true)
    List<Advertisement> getAdvertisementByAccommodationId (@Param ("accommodationid") Long accommodationId);
